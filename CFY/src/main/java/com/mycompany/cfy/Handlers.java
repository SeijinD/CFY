...
public class Handlers {
    ...
    public static void sqlExceptionHandler(SQLException e){
        try{
            BufferedWriter writer = new BufferedWriter(new FileWriter("src/main/resources/Logs/SQL_Logs.txt", true));
            writer.write("==============================\n");
    ...
    public static void fxExceptionHandler(Exception e){
        try{
            BufferedWriter writer = new BufferedWriter(new FileWriter("src/main/resources/Logs/JavaFX_Logs.txt", true));
            writer.write("==============================\n");
            writer.write(LocalDateTime.now() + "\n");
            writer.write("==============================\n");
